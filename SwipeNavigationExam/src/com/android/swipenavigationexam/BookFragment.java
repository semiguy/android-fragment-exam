...
public class BookFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		if(arguments != null) {
			...
			displayValues(theView, bookTitle, bookDescription, topCardResourceId);
		}
		
		return theView;
	}
	
	private void displayValues(View theView, String bookTitle, String bookDescription, int topCardResourceId) {
